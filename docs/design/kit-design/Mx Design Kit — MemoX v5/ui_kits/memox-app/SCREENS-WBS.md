...
| ------- | ------ | --------------------------------- | -------------------------------------- | ------------- | ------------------------------------------------------------------------------- | ------ | ------------------------------------------------------- |
| MX-01   | —      | Home / Dashboard group            | `index.html`                           | List          | Complete only when MX-01.1 to MX-01.5 are done                                  | todo   | Parent only; do not mark done manually                  |
...
| MX-01.3 | MX-01  | Empty first-run                   | `index.html`                           | List          | no decks / first-run empty state in dark + light; clear create/import action    | todo   | —                                                       |
| MX-01.4 | MX-01  | Load error                        | `index.html`                           | List          | load failed state in dark + light; copy says data is safe; retry action         | todo   | —                                                       |
| MX-01.5 | MX-01  | Deck tile states                  | `index.html`                           | List          | tile variants: due-badge / no-due / pre-SRS in dark + light                     | todo   | —                                                       |
| MX-02   | —      | Deck Management group             | `deck-management.card.html`            | List          | Complete only when MX-02.1 to MX-02.8 are done                                  | todo   | Parent only                                             |
| MX-02.1 | MX-02  | Loaded deck list                  | `deck-management.card.html`            | List          | loaded deck/subdeck list in dark + light                                        | todo   | —                                                       |
| MX-02.2 | MX-02  | Loading                           | `deck-management.card.html`            | List          | loading state in dark + light                                                   | todo   | —                                                       |
| MX-02.3 | MX-02  | Empty no decks                    | `deck-management.card.html`            | List          | empty no decks in dark + light                                                  | todo   | —                                                       |
| MX-02.4 | MX-02  | Search active                     | `deck-management.card.html`            | List          | active search/filter UI in dark + light                                         | todo   | —                                                       |
| MX-02.5 | MX-02  | Search empty                      | `deck-management.card.html`            | List          | search-empty state in dark + light                                              | todo   | —                                                       |
| MX-02.6 | MX-02  | Error                             | `deck-management.card.html`            | List          | load failed in dark + light; retry; data-safe copy                              | todo   | —                                                       |
| MX-02.7 | MX-02  | Row states                        | `deck-management.card.html`            | List          | row default / pressed / due-badge / no-due / disabled in dark + light           | todo   | —                                                       |
| MX-02.8 | MX-02  | Delete confirm                    | `deck-management.card.html`            | List          | delete high-risk confirm in dark + light                                        | todo   | —                                                       |
| MX-03   | —      | Deck Detail group                 | `deck-detail.card.html`                | Detail        | Complete only when MX-03.1 to MX-03.6 are done                                  | todo   | Parent only                                             |
| MX-03.1 | MX-03  | Audit existing loaded             | `deck-detail.card.html`                | Detail        | existing loaded state audited to DoD; dark + light parity                       | todo   | Exists; audit required                                  |
| MX-03.2 | MX-03  | Loading                           | `deck-detail.card.html`                | Detail        | loading state in dark + light                                                   | todo   | —                                                       |
| MX-03.3 | MX-03  | Empty deck                        | `deck-detail.card.html`                | Detail        | empty deck / no words in dark + light                                           | todo   | —                                                       |
| MX-03.4 | MX-03  | Error                             | `deck-detail.card.html`                | Detail        | load failed in dark + light                                                     | todo   | —                                                       |
| MX-03.5 | MX-03  | Study modes availability          | `deck-detail.card.html`                | Detail        | modes available + unavailable/soon variants in dark + light                     | todo   | —                                                       |
| MX-03.6 | MX-03  | Delete deck confirm               | `deck-detail.card.html`                | Detail        | destructive delete-deck confirm in dark + light                                 | todo   | —                                                       |
| MX-04   | —      | Review Words group                | `review-words.card.html`               | List          | Complete only when MX-04.1 to MX-04.8 are done                                  | todo   | Parent only                                             |
| MX-04.1 | MX-04  | Loaded browse                     | `review-words.card.html`               | List          | loaded read-only browse in dark + light                                         | todo   | —                                                       |
| MX-04.2 | MX-04  | Loading                           | `review-words.card.html`               | List          | loading in dark + light                                                         | todo   | —                                                       |
| MX-04.3 | MX-04  | Empty no words                    | `review-words.card.html`               | List          | empty no words in dark + light                                                  | todo   | —                                                       |
| MX-04.4 | MX-04  | Search active                     | `review-words.card.html`               | List          | search active in dark + light                                                   | todo   | —                                                       |
| MX-04.5 | MX-04  | Search empty                      | `review-words.card.html`               | List          | search-empty in dark + light                                                    | todo   | —                                                       |
| MX-04.6 | MX-04  | Read-only affordance              | `review-words.card.html`               | List          | no edit affordance / read-only visual treatment                                 | todo   | —                                                       |
| MX-04.7 | MX-04  | Long content wrapping             | `review-words.card.html`               | List          | long KO/EN content wraps or scrolls, no clipping                                | todo   | —                                                       |
| MX-04.8 | MX-04  | Error/audio unavailable           | `review-words.card.html`               | List          | error + audio unavailable variants in dark + light                              | todo   | —                                                       |
| MX-05   | —      | Play Menu group                   | `play-menu.card.html`                  | ModalSheet    | Complete only when MX-05.1 to MX-05.6 are done                                  | todo   | Parent only                                             |
| MX-05.1 | MX-05  | Normal all modes                  | `play-menu.card.html`                  | ModalSheet    | all modes available in dark + light                                             | todo   | —                                                       |
| MX-05.2 | MX-05  | New-only                          | `play-menu.card.html`                  | ModalSheet    | new cards only; repeat unavailable/no due                                       | todo   | —                                                       |
| MX-05.3 | MX-05  | Due-only                          | `play-menu.card.html`                  | ModalSheet    | due cards only; learn unavailable if no new cards                               | todo   | —                                                       |
| MX-05.4 | MX-05  | Partial modes                     | `play-menu.card.html`                  | ModalSheet    | some modes unavailable with explanation                                         | todo   | —                                                       |
| MX-05.5 | MX-05  | No due / all mastered             | `play-menu.card.html`                  | ModalSheet    | Repeat disabled; Nothing due; all-mastered positive state                       | todo   | —                                                       |
| MX-05.6 | MX-05  | Future actions                    | `play-menu.card.html`                  | ModalSheet    | game/player unavailable/soon state                                              | todo   | —                                                       |
| MX-06   | —      | New Learning — Review group       | `new-learning-review.card.html`        | Study         | Complete only when MX-06.1 to MX-06.6 are done                                  | todo   | Parent only                                             |
| MX-06.1 | MX-06  | Prompt/front                      | `new-learning-review.card.html`        | Study         | prompt/front state in dark + light                                              | todo   | —                                                       |
| MX-06.2 | MX-06  | Revealed meaning                  | `new-learning-review.card.html`        | Study         | revealed answer/meaning state in dark + light                                   | todo   | —                                                       |
| MX-06.3 | MX-06  | Audio playing                     | `new-learning-review.card.html`        | Study         | audio playing state with label/glyph                                            | todo   | —                                                       |
| MX-06.4 | MX-06  | Progress variants                 | `new-learning-review.card.html`        | Study         | progress start / mid / last card                                                | todo   | —                                                       |
| MX-06.5 | MX-06  | Protected exit                    | `new-learning-review.card.html`        | Study         | exit confirm in dark + light                                                    | todo   | —                                                       |
| MX-06.6 | MX-06  | Loading/error                     | `new-learning-review.card.html`        | Study         | loading + error state in dark + light                                           | todo   | —                                                       |
| MX-07   | —      | New Learning — Match group        | `new-learning-match.card.html`         | Study         | Complete only when MX-07.1 to MX-07.6 are done                                  | todo   | Parent only                                             |
| MX-07.1 | MX-07  | Default tiles                     | `new-learning-match.card.html`         | Study         | unmatched tile grid in dark + light                                             | todo   | —                                                       |
| MX-07.2 | MX-07  | Selected                          | `new-learning-match.card.html`         | Study         | selected tile state, not correct                                                | todo   | —                                                       |
| MX-07.3 | MX-07  | Correct pair                      | `new-learning-match.card.html`         | Study         | correct pair with color + glyph/label                                           | todo   | —                                                       |
| MX-07.4 | MX-07  | Wrong pair                        | `new-learning-match.card.html`         | Study         | wrong pair with color + glyph/label                                             | todo   | —                                                       |
| MX-07.5 | MX-07  | Completed/disabled                | `new-learning-match.card.html`         | Study         | all matched + disabled tile states                                              | todo   | —                                                       |
| MX-07.6 | MX-07  | Loading/error                     | `new-learning-match.card.html`         | Study         | loading + error state in dark + light                                           | todo   | —                                                       |
| MX-08   | —      | New Learning — Guess group        | `new-learning-guess.card.html`         | Study         | Complete only when MX-08.1 to MX-08.6 are done                                  | todo   | Parent only                                             |
| MX-08.1 | MX-08  | Options default                   | `new-learning-guess.card.html`         | Study         | default options in dark + light                                                 | todo   | —                                                       |
| MX-08.2 | MX-08  | Selected                          | `new-learning-guess.card.html`         | Study         | selected option, not correct                                                    | todo   | —                                                       |
| MX-08.3 | MX-08  | Correct                           | `new-learning-guess.card.html`         | Study         | correct answer state                                                            | todo   | —                                                       |
| MX-08.4 | MX-08  | Wrong                             | `new-learning-guess.card.html`         | Study         | wrong answer state                                                              | todo   | —                                                       |
| MX-08.5 | MX-08  | Disabled/reveal-correct           | `new-learning-guess.card.html`         | Study         | disabled post-answer + reveal correct answer                                    | todo   | —                                                       |
| MX-08.6 | MX-08  | Loading/error                     | `new-learning-guess.card.html`         | Study         | loading + error state                                                           | todo   | —                                                       |
| MX-09   | —      | New Learning — Recall group       | `new-learning-recall.card.html`        | Study         | Complete only when MX-09.1 to MX-09.6 are done                                  | todo   | Parent only                                             |
| MX-09.1 | MX-09  | Hidden recall prompt              | `new-learning-recall.card.html`        | Study         | hidden-answer prompt in dark + light                                            | todo   | —                                                       |
| MX-09.2 | MX-09  | Countdown                         | `new-learning-recall.card.html`        | Study         | 20s countdown visual state                                                      | todo   | —                                                       |
| MX-09.3 | MX-09  | Revealed                          | `new-learning-recall.card.html`        | Study         | revealed answer state                                                           | todo   | —                                                       |
| MX-09.4 | MX-09  | Timeout/forgotten                 | `new-learning-recall.card.html`        | Study         | timeout counts as forgotten                                                     | todo   | —                                                       |
| MX-09.5 | MX-09  | Forgot/remembered actions         | `new-learning-recall.card.html`        | Study         | forgot + remembered action states                                               | todo   | —                                                       |
| MX-09.6 | MX-09  | Loading/error                     | `new-learning-recall.card.html`        | Study         | loading + error state                                                           | todo   | —                                                       |
| MX-10   | —      | New Learning — Fill group         | `study-session.card.html`              | Study         | Complete only when MX-10.1 to MX-10.7 are done                                  | todo   | Parent only                                             |
| MX-10.1 | MX-10  | Audit existing fill               | `study-session.card.html`              | Study         | existing fill loaded audited to DoD                                             | todo   | Exists; audit required                                  |
| MX-10.2 | MX-10  | Empty input                       | `study-session.card.html`              | Study         | empty input in dark + light                                                     | todo   | —                                                       |
| MX-10.3 | MX-10  | Typing                            | `study-session.card.html`              | Study         | typed input + keyboard-safe layout                                              | todo   | —                                                       |
| MX-10.4 | MX-10  | Hint/checking                     | `study-session.card.html`              | Study         | hint + checking state                                                           | todo   | —                                                       |
| MX-10.5 | MX-10  | Correct                           | `study-session.card.html`              | Study         | correct fill state                                                              | todo   | —                                                       |
| MX-10.6 | MX-10  | Wrong                             | `study-session.card.html`              | Study         | wrong + correct shown + retry                                                   | todo   | —                                                       |
| MX-10.7 | MX-10  | Finalize failed                   | `study-session.card.html`              | Study         | finalize-failed, data safe + retry                                              | todo   | —                                                       |
| MX-11   | —      | Repeat Mode Menu group            | `repeat-mode-menu.card.html`           | ModalSheet    | Complete only when MX-11.1 to MX-11.4 are done                                  | todo   | Parent only                                             |
| MX-11.1 | MX-11  | Modes without reviewMode          | `repeat-mode-menu.card.html`           | ModalSheet    | match/guess/recall/fill only                                                    | todo   | —                                                       |
| MX-11.2 | MX-11  | No due                            | `repeat-mode-menu.card.html`           | ModalSheet    | Nothing due state, positive/neutral                                             | todo   | —                                                       |
| MX-11.3 | MX-11  | Unavailable/soon                  | `repeat-mode-menu.card.html`           | ModalSheet    | disabled mode with explanation                                                  | todo   | —                                                       |
| MX-11.4 | MX-11  | Dark/light modal parity           | `repeat-mode-menu.card.html`           | ModalSheet    | same component tree in both themes                                              | todo   | —                                                       |
| MX-12   | —      | SRS Repeat — Session group        | `srs-repeat.card.html`                 | Study         | Complete only when MX-12.1 to MX-12.6 are done                                  | todo   | Parent only                                             |
| MX-12.1 | MX-12  | Due card                          | `srs-repeat.card.html`                 | Study         | due SRS card, not pre-SRS                                                       | todo   | —                                                       |
| MX-12.2 | MX-12  | Correct box up                    | `srs-repeat.card.html`                 | Study         | correct state + box-up framing                                                  | todo   | —                                                       |
| MX-12.3 | MX-12  | Wrong/lapse                       | `srs-repeat.card.html`                 | Study         | wrong box down/lapse, never below Box 1                                         | todo   | —                                                       |
| MX-12.4 | MX-12  | No due empty session              | `srs-repeat.card.html`                 | Study         | no empty session; show no-due state                                             | todo   | —                                                       |
| MX-12.5 | MX-12  | Completed                         | `srs-repeat.card.html`                 | Study         | completed repeat flow                                                           | todo   | —                                                       |
| MX-12.6 | MX-12  | Loading/finalize failed           | `srs-repeat.card.html`                 | Study         | loading + finalize failed, data safe + retry                                    | todo   | —                                                       |
| MX-13   | —      | Session Result group              | `session-result.card.html`             | Result        | Complete only when MX-13.1 to MX-13.5 are done                                  | todo   | Parent only                                             |
| MX-13.1 | MX-13  | Finalizing                        | `session-result.card.html`             | Result        | finalizing/loading state                                                        | todo   | —                                                       |
| MX-13.2 | MX-13  | New Learning success              | `session-result.card.html`             | Result        | new learning result summary                                                     | todo   | —                                                       |
| MX-13.3 | MX-13  | SRS Repeat success                | `session-result.card.html`             | Result        | SRS repeat result summary                                                       | todo   | —                                                       |
| MX-13.4 | MX-13  | Finalize failed                   | `session-result.card.html`             | Result        | retry + data safe copy                                                          | todo   | —                                                       |
| MX-13.5 | MX-13  | Empty invalid                     | `session-result.card.html`             | Result        | empty nothing studied state                                                     | todo   | —                                                       |
| MX-14   | —      | Statistics group                  | `statistics.card.html`                 | Statistics    | Complete only when MX-14.1 to MX-14.7 are done                                  | todo   | Parent only                                             |
| MX-14.1 | MX-14  | Audit existing loaded             | `statistics.card.html`                 | Statistics    | existing loaded state audited to DoD                                            | todo   | Exists; audit required                                  |
| MX-14.2 | MX-14  | Loading                           | `statistics.card.html`                 | Statistics    | loading state in dark + light                                                   | todo   | —                                                       |
| MX-14.3 | MX-14  | Empty no history                  | `statistics.card.html`                 | Statistics    | empty no history state                                                          | todo   | —                                                       |
| MX-14.4 | MX-14  | No data per metric                | `statistics.card.html`                 | Statistics    | no-data state for selected metric                                               | todo   | —                                                       |
| MX-14.5 | MX-14  | Chart read-model needed           | `statistics.card.html`                 | Statistics    | read-model-needed, not fake chart data                                          | todo   | —                                                       |
| MX-14.6 | MX-14  | Tab switch                        | `statistics.card.html`                 | Statistics    | Words / Time / Quality tab switch states                                        | todo   | —                                                       |
| MX-14.7 | MX-14  | Error                             | `statistics.card.html`                 | Statistics    | load failed state                                                               | todo   | —                                                       |
| MX-15   | —      | Settings / More Hub group         | `settings.card.html`                   | Settings      | Complete only when MX-15.1 to MX-15.6 are done                                  | todo   | Parent only                                             |
| MX-15.1 | MX-15  | Audit existing loaded             | `settings.card.html`                   | Settings      | existing loaded state audited to DoD                                            | todo   | Exists; audit required                                  |
| MX-15.2 | MX-15  | Activity empty                    | `settings.card.html`                   | Settings      | no activity summary state                                                       | todo   | —                                                       |
| MX-15.3 | MX-15  | Switch on/off                     | `settings.card.html`                   | Settings      | switch variants                                                                 | todo   | —                                                       |
| MX-15.4 | MX-15  | High-risk section                 | `settings.card.html`                   | Settings      | high-risk row grouping                                                          | todo   | —                                                       |
| MX-15.5 | MX-15  | Unavailable/soon row              | `settings.card.html`                   | Settings      | future/unavailable row                                                          | todo   | —                                                       |
| MX-15.6 | MX-15  | Destructive confirm/error         | `settings.card.html`                   | Settings      | destructive confirm + error                                                     | todo   | —                                                       |
