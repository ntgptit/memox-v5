...
> `F1.DM.1`, `F1.DM.SORT.1`, `F1.DM.PLAY.1`, `F1.STUDY.NEW.REVIEW.1`, `F1.STUDY.NEW.MATCH.1`, `F1.STUDY.NEW.GUESS.1`, `F1.STUDY.NEW.RECALL.1`, and `F1.STUDY.NEW.FILL.1` are docs rows: they flip to `Done` once this PR is
